...
// 2. Create PatientDashboard.jsx
const patientDashboard = `import React, { useState, useEffect } from 'react';
import { 
                  ...
                  <div className="bg-white rounded-[24px] p-8 shadow-sm border border-gray-100">
                    ...
                    {myAppointments.length > 0 ? (
                      ...
                      <div className="text-center py-10 bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200">
                        ...
                        <Link to="/doctor-visit" className="text-secondary font-bold hover:underline">Find a Doctor</Link>
                      </div>
                    )}
                  </div>
...
fs.writeFileSync('src/pages/PatientDashboard.jsx', patientDashboard);

// 3. Add to App.jsx
let appContent = fs.readFileSync('src/App.jsx', 'utf8');
if (!appContent.includes('PatientDashboard')) {
...
console.log('Patient Dashboard Created and Routed');
