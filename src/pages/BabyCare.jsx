...
export default function BabyCare() {
  ...
  const faqs = [
    { q: "How quickly can a home nurse visit my home?", a: "We can arrange a caregiver within 12-24 hours depending on your requirements. Same-day slots may be available." },
    { q: "What equipment does the nurse bring?", a: "Our home nurses bring necessary basic medical kits. For specialized ICU setups, we help arrange equipment separately, and basic assessment tools." },
      ...
      <section className="pt-32 pb-20 lg:pt-44 lg:pb-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 bg-gradient-to-br from-white to-[#F0F4FF] overflow-hidden">
        ...
        <div className="lg:w-[45%] relative mt-10 lg:mt-0 w-full">
          <div className="relative rounded-[2rem] overflow-hidden shadow-[0_20px_50px_rgba(30,58,138,0.15)] animate-[float_4s_ease-in-out_infinite]">
            <img 
              src="/homecare-hero.png" 
              alt="Home Nurse treating patient at home" 
        ...
        <div className="flex flex-col md:flex-row items-center gap-16">
          <div className="md:w-[60%]">
            ...
            <p className="text-lg text-[#5A6478] mb-8 leading-relaxed">
              Carevia connects you with compassionate, background-checked caregivers and nurses who provide continuous support tailored to your specific needs.
            </p>
      ...
      <section className="py-24 bg-[#F0F4FF]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-[40px] font-semibold font-poppins text-primary mb-4">Conditions We Support at Home</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center max-w-5xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
              ...
              <ul className="space-y-4 mb-8">
                ...
                <li className="flex items-start gap-2 text-sm text-primary"><CheckCircle className="w-5 h-5 text-[#10B981] shrink-0" /> Dedicated home nurse</li>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto bg-gradient-to-r from-secondary to-primary rounded-[32px] p-10 md:p-16 text-center text-white shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg md:text-xl mb-10 opacity-90 max-w-2xl mx-auto">Book a certified home nurse to visit your home today. Same-day slots available.</p>
