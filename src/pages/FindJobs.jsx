...
export default function FindJobs() {
  ...
  const jobs = [
    ...
    { category: "Baby Care", icon: <Heart className="w-5 h-5 text-rose-500" />, iconBg: "bg-rose-50", badgeBg: "bg-rose-50", badgeText: "text-rose-600", title: "Baby Care Specialist", loc: "Chennai", time: "Full-Time", desc: "Lead the delivery of high-quality home care, assisting patients with daily activities, monitoring vitals, and ensuring absolute comfort." },
