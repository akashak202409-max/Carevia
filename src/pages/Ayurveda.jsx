...
export default function Ayurveda() {
  ...
  const conditions = [
    ...
    { icon: "👵", name: "Geriatric Ayurveda", desc: "Care designed for seniors" }
  ];
  ...
  const faqs = [
    { q: "How quickly can a Ayurvedic doctor visit my home?", a: "We typically arrange a visit within 24-48 hours of booking. Same-day slots may be available." },
    { q: "What equipment does the Ayurveda bring?", a: "Our Ayurvedic doctors carry essential portable equipment, such as resistance bands, ultrasound therapy machines, and basic assessment tools." },
      ...
      <section className="pt-32 pb-20 lg:pt-44 lg:pb-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 bg-gradient-to-br from-white to-[#F0F4FF] overflow-hidden">
        <div className="lg:w-[55%] flex flex-col items-start z-10">
          <div className="bg-[#FEF2F2] text-secondary px-4 py-1.5 rounded-full text-sm font-medium flex items-center gap-2 mb-6 border border-[#fbd4d4]">
            🏠 Certified Ayurvedas at Your Doorstep
          </div>
          <div className="text-sm text-gray-500 mb-4 font-medium flex items-center gap-2">
            ...
            <span className="text-primary">Ayurveda therapy</span>
          </div>
          <h1 className="text-4xl sm:text-5xl lg:text-[56px] font-bold leading-[1.1] mb-6 font-poppins text-primary">
            Authentic Ayurveda, <br/>Delivered to Your Home.
          </h1>
          <p className="text-lg text-[#5A6478] mb-8 max-w-[500px] leading-relaxed">
            Recover from pain, injury, or surgery with certified Ayurvedic doctors who visit you at home. Personalized care, zero travel, faster healing.
          </p>
          
          <div className="flex flex-wrap gap-4 mb-10 items-center text-sm font-medium text-primary">
            <span className="flex items-center gap-1 bg-white px-3 py-1.5 rounded-full shadow-sm"><span className="text-green-500">✅</span> 500+ Certified Ayurvedas</span>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-6 w-full sm:w-auto">
            ...
            <button className="bg-transparent border-2 border-primary text-primary hover:bg-[#F0F4FF] px-6 py-3 rounded-xl font-medium text-base transition flex items-center justify-center gap-2">
              <Phone className="w-5 h-5" /> Talk to a Ayurveda Now
            </button>
          </div>
        ...
        <div className="lg:w-[45%] relative mt-10 lg:mt-0 w-full">
          <div className="relative rounded-[2rem] overflow-hidden shadow-[0_20px_50px_rgba(30,58,138,0.15)] animate-[float_4s_ease-in-out_infinite]">
            <img 
              ...
              alt="Ayurvedic doctor treating patient at home" 
        ...
        <div className="flex flex-col md:flex-row items-center gap-16">
          <div className="md:w-[60%]">
            <h2 className="text-3xl md:text-[40px] font-semibold font-poppins text-primary mb-6 leading-tight">
              Ayurveda therapy That Comes to You
            </h2>
            ...
            <p className="text-lg text-[#5A6478] mb-8 leading-relaxed">
              Carevia connects you with highly qualified, background-checked Ayurvedic doctors who design custom treatment plans tailored to your home environment.
            </p>
          ...
          <div className="md:w-[40%] relative">
            ...
            <img 
              src="/Ayurveda-section.png" 
              alt="Ayurveda therapy session" 
      ...
      <section className="py-24 bg-[#F0F4FF]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-[40px] font-semibold font-poppins text-primary mb-4">Conditions Our Ayurvedic doctors Treat</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center max-w-5xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-start gap-2 text-sm text-primary"><CheckCircle className="w-5 h-5 text-[#10B981] shrink-0" /> 60-min herbal therapy</li>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
              ...
              <ul className="space-y-4 mb-8">
                ...
                <li className="flex items-start gap-2 text-sm text-primary"><CheckCircle className="w-5 h-5 text-[#10B981] shrink-0" /> Dedicated Ayurvedic doctor</li>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto bg-gradient-to-r from-secondary to-primary rounded-[32px] p-10 md:p-16 text-center text-white shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg md:text-xl mb-10 opacity-90 max-w-2xl mx-auto">Book a certified Ayurvedic doctor to visit your home today. Same-day slots available.</p>
