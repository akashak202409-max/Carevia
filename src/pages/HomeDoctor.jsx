...
export default function HomeDoctor() {
  ...
  const conditions = [
    ...
    { icon: "👵", name: "Geriatric Doctor", desc: "Care designed for seniors" }
  ];
  ...
  const faqs = [
    { q: "How quickly can a doctor visit my home?", a: "We typically arrange a visit within 24-48 hours of booking. Same-day slots may be available." },
    { q: "What equipment does the Doctor bring?", a: "Our doctors carry essential portable equipment, such as resistance bands, ultrasound therapy machines, and basic assessment tools." },
  ...
  return (
    <div className="font-sans text-primary bg-[#FAFBFC] min-h-screen relative selection:bg-primary selection:text-white">
      ...
      <section className="pt-32 pb-20 lg:pt-44 lg:pb-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 bg-gradient-to-br from-white to-[#F0F4FF] overflow-hidden">
        <div className="lg:w-[55%] flex flex-col items-start z-10">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-[56px] font-bold leading-[1.1] mb-6 font-poppins text-primary">
            Professional Home Doctor, <br/>Delivered to Your Home.
          </h1>
          <p className="text-lg text-[#5A6478] mb-8 max-w-[500px] leading-relaxed">
            Recover from pain, injury, or surgery with certified doctors who visit you at home. Personalized care, zero travel, faster healing.
          </p>
        ...
        <div className="flex flex-col md:flex-row items-center gap-16">
          <div className="md:w-[60%]">
            <h2 className="text-3xl md:text-[40px] font-semibold font-poppins text-primary mb-6 leading-tight">
              doctor visit That Comes to You
            </h2>
            ...
            <p className="text-lg text-[#5A6478] mb-8 leading-relaxed">
              Carevia connects you with highly qualified, background-checked doctors who design custom treatment plans tailored to your home environment.
            </p>
      ...
      <BookingModal isOpen={isBookingModalOpen} onClose={() => setIsBookingModalOpen(false)} serviceType="home-doctor" />
    </div>
  );
}
